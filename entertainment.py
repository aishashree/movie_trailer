...
import media
"""List of movies"""
mickey_mouse = media.Movie("Mickeymouse",
                "Story of mickey mouse",
                "https://upload.wikimedia.org/wikipedia/en/e/ed/Mickey_Mouse_film_poster.png",
                "https://www.youtube.com/watch?v=R86XY9lmtMs")

jumanji = media.Movie("Jumanji",
                "A story of playing a game",
                "https://upload.wikimedia.org/wikipedia/en/b/b6/Jumanji_poster.jpg",
                "https://www.youtube.com/watch?v=5p18zqZmeiI")

angry_birds = media.Movie("Angrybird",
                "A story of a bird",
                "https://upload.wikimedia.org/wikipedia/en/f/f9/The_Angry_Birds_Movie_poster.png",
                "https://www.youtube.com/watch?v=QRmKa7vvct4")

spykids = media.Movie("Spykids",
                "A story of kids",
                "https://upload.wikimedia.org/wikipedia/en/2/26/Spy_kids.jpg",
                "https://www.youtube.com/watch?v=wAQAkfOyAEY")

finding_nemo = media.Movie("FindingNemo",
                "A story of a fish",
...
art = media.Movie("Box_art",
                "Art using python program",
                "boxart image",
                "images.PNG")
